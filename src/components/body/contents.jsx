        ...
        <div>
          <h4>
            <a
              className="link"
              target="_blank"
              href="https://www.vem-group.com/en/energiesparrechner/"
            >
              {" "}
    ...
    <div id="">
      ...
      <div className="card" id="teams">
        <ul>
          ...
          <li>
            <a
              href="https://github.com/praweensoni01/"
              target="_blank"
              className="link"
            >
              Praween Soni
          ...
          <li>
            <a
              href="https://github.com/Saurabh-Mahto/"
              target="_blank"
              className="link"
            >
              Saurabh Mahto
...
const Contribute = () => {
  return (
    <div>
      <p className="section_title">Contribute</p>
      <div className="card">
        <a className="link" href="https://github.com/andmhn/climate-awareness/">
